...
// Mostra o popup customizado
    ...
    installPopup.innerHTML = `
        <div style="position:fixed;top:80px;text-center;transform:translate(50%,-50%);z-index:9999;background:#fff;border-radius:12px;padding:20px;box-shadow:0 4px 16px rgba(0,0,0,0.2);text-align:center;">
